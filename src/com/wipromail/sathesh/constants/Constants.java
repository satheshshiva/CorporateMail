...
public interface Constants {
	...
	public static final String INBOX_TEXT_DATE_YESTERDAY = "Yesterday";
	public static final String INBOX_TEXT_DATE_WEEK = "EEEEE";
	public static final String INBOX_TEXT_DATE_MONTH = "d-MMM";
	public static final String INBOX_TEXT_DATE_YEAR = "d-MMM-yy";
	
	//inbox date headerformats
		public static final String INBOX_TEXT_DATE_TODAY_HEADER = "Today";
		public static final String INBOX_TEXT_DATE_YESTERDAY_HEADER = "Yesterday";
		public static final String INBOX_TEXT_DATE_DAY_HEADER = "EEEEE";
		public static final String INBOX_TEXT_DATE_YEAR_HEADER = "d-MMM-yy";
		public static final String INBOX_TEXT_DATE_DELIMITER = "\t";
