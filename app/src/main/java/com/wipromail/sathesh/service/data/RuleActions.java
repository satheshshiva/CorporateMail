/**************************************************************************
 * copyright file="RuleActions.java" company="Microsoft"
...
public final class RuleActions extends ComplexProperty {
	...
	throws Exception {
		...
		if (this.getSendSMSAlertToRecipients().size() > 0) {
			EmailAddressCollection emailCollection = convertSMSRecipientsFromMobilePhoneCollectionToEmailAddressCollection(
