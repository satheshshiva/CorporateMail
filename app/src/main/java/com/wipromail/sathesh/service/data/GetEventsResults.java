...
public final class GetEventsResults {
	 ...
	 * @param reader
	 *            the reader
	 * @param eventElementName
	 *            the event element name
	 * @param eventType
	 *            the event type
	 * @throws Exception
	 *             the exception
	...
	//THE FOLLOWING ARE MANUALLY ADDED METHODS.. THESE METHODS ARE DECLARES AS PROTECTED IN THE FINAL CLASS. HENCE MAKING IT PUBLIC.
	 ...
	 * @return the previous watermark
	 */
	public String getPreviousWatermark1() {
		return previousWatermark;
	}
	 ...
	 * @return the new watermark
	 */
	public String getNewWatermark1() {
		return newWatermark;
	}
