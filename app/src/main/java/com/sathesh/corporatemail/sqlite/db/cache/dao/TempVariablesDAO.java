...
import com.sathesh.corporatemail.sqlite.db.cache.vo.TempVariablesVO;
...
public class TempVariablesDAO extends BaseCacheDAO {
    ...
    private Class tableClass= com.sathesh.corporatemail.sqlite.db.cache.tables.TableTempVariables.class;
    private Class voClass= com.sathesh.corporatemail.sqlite.db.cache.vo.TempVariablesVO.class;
