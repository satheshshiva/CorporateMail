...
public class CachedMailBodyDAO extends BaseCacheDAO {
    ...
    private Class tableClass= com.sathesh.corporatemail.sqlite.db.cache.tables.TableCachedMailBody.class;
    private Class voClass= com.sathesh.corporatemail.sqlite.db.cache.vo.CachedMailBodyVO.class;
