...
public class CachedMailHeaderDAO extends BaseCacheDAO {
    ...
    private Class tableClass= com.sathesh.corporatemail.sqlite.db.cache.tables.TableCachedMailHeader.class;
    private Class voClass= com.sathesh.corporatemail.sqlite.db.cache.vo.CachedMailHeaderVO.class;
